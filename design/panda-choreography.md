...
- **Phase 5** — split & lifecycle — **in progress (2026-07-23).** Phase 4 borrows a minimal split; the dissolve/reform churn + bounds are owed here.
