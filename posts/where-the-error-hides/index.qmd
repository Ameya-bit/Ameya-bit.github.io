...
![Validation against theory. (a) The Monte Carlo beaming function against Chandrasekhar's exact $H(\mu)$, residuals within ±2σ. (b, c) Static and rotating pulse profiles against published reference waveforms — maximum deviation 0.11% and 1.35%.](figures/fig1_validation.png)
...
![PSR J0740+6620 modeled both ways. (a, b) Pulse profiles under the Riley and Miller geometries — isotropic dashed, realistic beaming solid; the shaded area is the error under test. (c) $\Delta\mathrm{PF}$ against slab optical depth, saturating above $\tau \approx 3$.](figures/fig2_j0740.png)
...
![PSR J0030+0451, the anchor that shows nothing. (a, b) Both geometries pin $\mathrm{PF} = 1$ for isotropic and realistic emission alike — $\Delta\mathrm{PF} \equiv 0$ — while the waveforms disagree in shape (rms 0.061 and 0.058). (c) The shape difference against optical depth.](figures/fig3_j0030.png)
...
![The re-routing, step by step. (a) $\Delta\mathrm{PF}$ for J0740 as spin, energy band, and light-travel delay are added — the amplitude bias collapses from +0.14/+0.20 toward +0.02/+0.07. (b) The waveform-shape difference across the same ladder: RMS ≈ 0.10, unmoved.](figures/fig4_routing.png)
